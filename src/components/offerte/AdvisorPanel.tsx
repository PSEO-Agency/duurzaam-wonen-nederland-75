...
const AdvisorPanel: React.FC = () => {
  ...
  return (
    <Card className="bg-white shadow-sm border-0 h-full w-72">
          ...
          {advisors.map((advisor, index) => (
            <div key={index} className="flex-1">
              <div className="flex flex-col items-center">
                ...
                <div className="bg-gray-50 p-2 rounded-lg mt-2 w-full">
                  <blockquote className="text-gray-600 italic text-xs">
                    "{advisor.quote}"
                  </blockquote>
                </div>
              </div>
