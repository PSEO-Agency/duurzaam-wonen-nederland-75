...
import { Check, Filter, ArrowRight, ArrowDown, Star, ChevronDown, ExternalLink } from 'lucide-react';
              ...
              <AnimatedSection animation="fade-in" delay={100}>
                <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                  <div className="relative h-64 bg-gray-100 rounded-t-lg overflow-hidden">
                    <img 
                      src="/lovable-uploads/59bc8ed5-3639-402b-8eac-33fa699bdb9a.png" 
                      alt="Schüco Living 82 profiel doorsnede"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-3">
                      <h3 className="text-xl font-semibold">Schüco Living 82</h3>
                      <img 
                    ...
                    <p className="text-gray-600 mb-6 leading-relaxed">
                      Premium profiel met uitstekende isolatiewaarden en moderne uitstraling
                    </p>
                    <Button 
                      variant="outline" 
              ...
              <AnimatedSection animation="fade-in" delay={200}>
                <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                  <div className="relative h-64 bg-gray-100 rounded-t-lg overflow-hidden">
                    <img 
                      src="/lovable-uploads/59bc8ed5-3639-402b-8eac-33fa699bdb9a.png" 
                      alt="Schüco CT 70 AS profiel doorsnede"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-3">
                      <h3 className="text-xl font-semibold">Schüco CT 70 AS</h3>
                      <img 
                        src="/lovable-uploads/99e8ffe7-223a-46ac-be41-cb3fa5043750.png" 
                        alt="Schüco" 
                        className="h-5 w-auto"
                    ...
                    <p className="text-gray-600 mb-6 leading-relaxed">
                      Veelzijdig profiel voor renovatie en nieuwbouw projecten
                    </p>
                    <Button 
                      variant="outline" 
                      className="w-full border-gray-300 hover:border-brand-green hover:text-brand-green"
