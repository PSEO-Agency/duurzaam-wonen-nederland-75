...
const colorData: Record<string, ColorOption> = {
  ...
  "crème": {
    ...
    popular: true,
    ralCode: "RAL 9001",
    history: "Crème is een zachte, warme tint die vaak wordt gebruikt in traditionele architectuur. Het is een populair alternatief voor zuiver wit, omdat het een warmere uitstraling heeft en minder gevoelig is voor zichtbaar vuil. Crème kozijnen werden vooral populair in landelijke en traditionele woningbouw.",
    applications: [
      "Landelijke woningen",
