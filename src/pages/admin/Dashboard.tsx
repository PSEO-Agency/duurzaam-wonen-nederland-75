...
const data = [
  ...
  { name: 'Apr', visitors: 278 },
  { name: 'Mei', visitors: 189 },
  { name: 'Jun', visitors: 239 },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Overzicht van uw website statistieken</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+15% t.o.v. vorige maand</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+8% t.o.v. vorige maand</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+2% t.o.v. vorige maand</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Bezoekers per maand</CardTitle>
            <CardDescription>Overzicht van website bezoekers</CardDescription>
          </CardHeader>
          <CardContent>
