...
const Raamdecoratie = lazy(() => import('./pages/Raamdecoratie'));
          ...
          <AdminWrapper>
            <Suspense fallback={<div>Loading...</div>}>
              <Routes>
                ...
                {/* Product routes - using dedicated components or ProductPage */}
                ...
                <Route path="/raamdecoratie" element={<Raamdecoratie />} />
